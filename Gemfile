...
gem 'actionmailer', '7.0.4.3' # Rails. Send email.
gem 'actionpack', '7.0.4.3' # Rails. MVC framework.
gem 'actionview', '7.0.4.3' # Rails. View.
gem 'activejob', '7.0.4.3' # Rails. Async jobs.
gem 'activemodel', '7.0.4.3' # Rails. Model basics.
gem 'activerecord', '7.0.4.3' # Rails. ORM and query system.
# gem 'activestorage' # Not used. Attaches cloud files to ActiveRecord.
gem 'activesupport', '7.0.4.3' # Rails. Underlying library.
...
gem 'railties', '7.0.4.3' # Rails. Rails core, loads rest of Rails
...
group :development do
  ...
  gem 'rails', '7.0.4.3' # Rails (our web framework)
